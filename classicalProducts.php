...
<div class="s">
    <h2>Classical Items</h2>
</div>
<div class="center">
    
<div class="gallery">
        <a href="index.php?page=classicalPdt.php">
            <img src="images/arm_chair.png">
        </a>
        <div class="desc">Arm chair</div>
    </div>
    <div class="gallery">
        <a href="index.php?page=classicalCarpets.php" >
    ...
    <?php
        ...
        for($index=0; $index < $rows; $index++){
            while($row=mysqli_fetch_array($result)){
                ...
                echo "<a  href='index.php?page=classicalPdt.php&id=".$row['product_id']."'>";
             //   echo "<a  href='index.php?page=singlePiece.php&id=".$row['product_id']."'>";
