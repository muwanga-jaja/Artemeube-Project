...
<div class="container-register">
    ...
    <h3 style="padding:10px;width:200px; margin-bottom:40px; margin-top:-70px;">Add Design Photo</h3>
        ...
        <input type="submit" name="submit_design" class="button" value="submit ">
    </form>
